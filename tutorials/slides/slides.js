      (function() {
        ...
        SlideShow.prototype = {
          ...
          togglePrint: function(){
          	...
          	var printing = this.printing;
            queryAll('.presentation').forEach(function(el) {
              el.style.overflow = (printing) ? 'auto' : '';
              el.style.background = (printing) ? 'white' : '';
            });
            queryAll('.slide').forEach(function(el) {
              el.style.display = (printing) ? 'block' : '';
              el.style.position = (printing) ? 'static' : '';
              el.style.marginTop = (printing) ? '10px' : '';
              el.style.border =(printing) ? 'solid 2px black' : '';
              
            });
            queryAll('.past').forEach(function(el) {
              el.style.display = 'block' ;
              el.style.marginLeft = (printing) ? '0px' : '';
            });
            queryAll('.current').forEach(function(el) {
              el.style.display = 'block' ;
              el.style.marginLeft = (printing) ? '0px' : '';
            });
            queryAll('.future').forEach(function(el) {
              el.style.display = 'block' ;
              el.style.marginLeft = (printing) ? '0px' : '';
            });
            queryAll('.far-future').forEach(function(el) {
              el.style.display = 'block' ;
              el.style.marginLeft = (printing) ? '0px' : '';
            });
            queryAll('.distant-slide').forEach(function(el) {
              el.style.display = (printing) ? 'block' : '';
            });
