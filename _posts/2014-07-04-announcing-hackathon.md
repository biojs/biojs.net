...
In this week we try to tackle some of the current weaknesses of the BioJS codebase and
combine the benfits of 
...
* use an asynchronous module definition (__AMD__, we will use RequireJS as lib)
